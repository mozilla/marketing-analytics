...
def load_new_data(dataset_id, table_name, next_load_date, end_load_date):
    ...
    load_job_config.time_partitioning = bigquery.TimePartitioning(
        ...
        field='date')
    load_job_config.clustering_fields = ['country', 'browser', 'blog', 'subblog']
    ...
    sql = f"""
        ...
        GROUP BY
          date, deviceCategory, operatingSystem, browser, language, country, standardized_country_name, source, medium, campaign, content, blog, subblog
        """
...
def run_site_metrics_update():
    ...
    read_table_name = 'blogs_daily_summary'
